...
function renderMarkdown(source: string, maxChars: number): ReactNode {
...
export const FiniteMarkdown = memo(function FiniteMarkdown({ source, maxChars }: { source: string; maxChars: number }) {
  const content = useMemo(() => renderMarkdown(source, maxChars), [source, maxChars])
